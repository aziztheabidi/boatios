...
struct FindBoatPopUpView: View {
    ...
    init(
        ...
        _viewModel = StateObject(wrappedValue: FindBoatPopUpViewModel(
            bookingRepository: LiveBookingRepository(network: dependencies.networkRepository)
        ))
    }
...
struct ConfirmView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        .environmentObject(VoyagerHomeViewModel(
            networkRepository: LiveBookingRepository(network: AppDependencies.live.networkRepository),
