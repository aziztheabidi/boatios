...
final class OTPViewModel: ObservableObject {
    ...
    init(networkRepository: RegistrationRepositoryProtocol, tokenStore: TokenStoring) {
    ...
    private func performVerifyOTP(email: String, otp: Int) {
        ...
        Task {
            do {
                let response = try await networkRepository.verifyRegistrationTemp(parameters: ["OTP": otp, "Email": email])
