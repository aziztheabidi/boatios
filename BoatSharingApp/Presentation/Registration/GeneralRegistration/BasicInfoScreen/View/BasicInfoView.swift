...
struct BasicInfoView: View {
    ...
    init(dependencies: AppDependencies = .live) {
        ...
        _viewModel = StateObject(wrappedValue: BasicInfoViewModel(networkRepository: LiveRegistrationRepository(network: dependencies.networkRepository)))
    }
    ...
    var body: some View {
        NavigationStack {
            VStack {
                ...
                NavigationLink(
                    destination: OTPView(email: email, dependencies: dependencies),
                    isActive: Binding(
