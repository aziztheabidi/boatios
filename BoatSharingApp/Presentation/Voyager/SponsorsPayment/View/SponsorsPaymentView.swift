...
struct SponsorPaymentsView: View {
    ...
    init(dependencies: AppDependencies = .live) {
        ...
        _viewModel = StateObject(wrappedValue: SponsorsPaymentViewModel(
            networkRepository: LivePaymentRepository(network: dependencies.networkRepository),
    ...
    var body: some View {
        NavigationStack {
            ...
            NavigationLink(
                destination: PaymentPopUpView(type: .SponsorPayment, receiptEmail: dependencies.sessionPreferences.userEmail),
