...
struct VoyagerHomeView: View {
    ...
    init(dependencies: AppDependencies = .live) {
        ...
        _viewModel = StateObject(wrappedValue: VoyagerHomeViewModel(
            networkRepository: LiveDashboardRepository(network: dependencies.networkRepository),
                ...
                if viewModel.state.isCaptainFind, let voyage = viewModel.state.voyage {
                    ZStack {
                        ...
                        VStack(spacing: 0) {
                            ...
                            ZStack(alignment: .top) {
                                NewRequestFinal_PopUpView(showSheet: $viewModel.isCaptainFind, voyage: voyage)
