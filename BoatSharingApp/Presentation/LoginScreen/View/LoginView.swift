    ...
    var body: some View {
        NavigationStack {
            VStack {
                ...
                // **Navigation Links**
                NavigationLink(destination: ResetPasswordView(dependencies: dependencies), isActive: $navigateToForgot) {
                    EmptyView()
                }
                
                NavigationLink(destination: BasicInfoView(dependencies: dependencies), isActive: $navigateToCreateAccount) {
                    EmptyView()
