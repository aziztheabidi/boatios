...
final class BusinessActiveVoyageViewModel: ObservableObject {
    ...
    private let networkRepository: BusinessVoyageRepositoryProtocol
    private let sessionPreferences: SessionPreferenceStoring
    private var hasLoaded = false

    init(networkRepository: BusinessVoyageRepositoryProtocol, sessionPreferences: SessionPreferenceStoring) {
