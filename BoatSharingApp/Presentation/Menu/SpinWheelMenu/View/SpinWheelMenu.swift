...
struct SpinWheelMenu: View {
    ...
    private var navigationLinks: some View {
        Group {
            ...
            NavigationLink(
                destination: CaptainHomeView(dependencies: dependencies),
                isActive: $goToCaptainDashboard
            ) { EmptyView() }

            NavigationLink(
                destination: DashboardView(dependencies: dependencies),
            ...
            NavigationLink(destination: ResetPasswordView(dependencies: dependencies), isActive: $navigateToResetPassword) {
                EmptyView().navigationBarBackButtonHidden(true)
            }
